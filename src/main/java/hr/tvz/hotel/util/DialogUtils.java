...
/**
 * Prikazuje JavaFX dijaloške okvire za potvrdu, obavijest i grešku.
 * Sprječava ponavljanje koda u kontrolerima.
 */
public final class DialogUtils {
    ...
    /**
     * Prikazuje dijalog za potvrdu akcije i čeka korisnikov odgovor.
     *
     * @param title   naslov dijaloga
     * @param message poruka koja se prikazuje korisniku
     * @return {@code true}, korisnik potvrdio akciju gumbom OK
     */
